...
const Icon: React.FC<IconProps> = ({name, height = "24px", width = "24px", color = "currentColor"}) => {
  // Define a function that returns the correct SVG based on the icon name
  const renderIcon = () => {
    switch (name) {
      case "title":
        return (
          <svg width={width} height={height} viewBox="0 -2 20 20" xmlns="http://www.w3.org/2000/svg">
      ...
      case "drag-handle":
        return (
          <svg height={height} width={width} viewBox="0 0 24 24" fill={color} focusable="false" aria-hidden="true">
            <path
      ...
      case "search":
        return (
          <svg height={height} width={width} focusable="false" aria-hidden="true" fill={color}>
            <path
      ...
      case "edit":
        return (
          <svg height={height} width={width} focusable="false" aria-hidden="true" fill={color}>
            <path
              d="M3 21h3.75L17.81 9.94l-3.75-3.75L3 17.25zm2-2.92 9.06-9.06.92.92L5.92 19H5zM18.37 3.29a.996.996 0 0 0-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83c.39-.39.39-1.02 0-1.41z"></path>
          </svg>
        );
      case "delete":
        return (
      ...
      case "image":
        return (
          <svg xmlns="http://www.w3.org/2000/svg" height={height} width={width} viewBox="0 0 24 24" fill={color}>
            <path
              d="M21 19V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2M8.5 13.5l2.5 3.01L14.5 12l4.5 6H5z"></path>
          </svg>
        );
      case "website":
        return (
      ...
      case "color":
        return (
          <svg xmlns="http://www.w3.org/2000/svg" height={height} width={width} viewBox="0 0 24 24" fill={color}>
            <path
              d="m16.81 8.94-3.75-3.75L4 14.25V18h3.75zM6 16v-.92l7.06-7.06.92.92L6.92 16zm13.71-9.96c.39-.39.39-1.02 0-1.41l-2.34-2.34c-.2-.2-.45-.29-.71-.29-.25 0-.51.1-.7.29l-1.83 1.83 3.75 3.75zM2 20h20v4H2z"></path>
          </svg>
        );
      ...
      case "link":
        return (
          <svg xmlns="http://www.w3.org/2000/svg" height={height} width={width} viewBox="0 0 24 24" fill={color}>
            <path
              d="M16.5 6v11.5c0 2.21-1.79 4-4 4s-4-1.79-4-4V5c0-1.38 1.12-2.5 2.5-2.5s2.5 1.12 2.5 2.5v10.5c0 .55-.45 1-1 1s-1-.45-1-1V6H10v9.5c0 1.38 1.12 2.5 2.5 2.5s2.5-1.12 2.5-2.5V5c0-2.21-1.79-4-4-4S7 2.79 7 5v12.5c0 3.04 2.46 5.5 5.5 5.5s5.5-2.46 5.5-5.5V6z"></path>
          </svg>
        );
      ...
      case "facebook":
        return (
          <svg xmlns="http://www.w3.org/2000/svg" height={height} width={width} viewBox="0 0 24 24" fill={color}>
            <path
              d="M22.675 0H1.325C.593 0 0 .593 0 1.325v21.351C0 23.407.593 24 1.325 24H12.82v-9.294H9.692v-3.622h3.128V8.413c0-3.1 1.894-4.788 4.66-4.788 1.325 0 2.463.099 2.796.143v3.24l-1.92.001c-1.504 0-1.794.715-1.794 1.763v2.31h3.587l-.467 3.622h-3.12V24h6.116C23.407 24 24 23.407 24 22.676V1.325C24 .593 23.407 0 22.675 0z"/>
          </svg>
        );
      ...
      case "arrow-down":
        return (
          <svg xmlns="http://www.w3.org/2000/svg" height={height} width={width} viewBox="0 0 24 24" color={color}>
