          ...
          <div className="flex w-full flex-col justify-center lg:w-6/12">
            <div className="content">
              <div className="mb-6">
                ...
                <p className="text-lg md:text-xl leading-[1.2]">
                  No coding skills? No problem. With SmartLeadMagnet’s intuitive drag-and-drop interface, you can
                  create and customize your lead magnets in minutes. Choose from a variety of pre-designed templates and
              ...
              <p className="mb-8 mt-4 text-lg md:text-xl leading-[1.2]">
                Once your lead magnet is ready, simply copy the generated iframe and integrate it into your website
                with ease. No complex setup or third-party tools required—just instant results.
              </p>
              <h3 className="text-l5-secondary text-xl font-bold md:text-2xl">📈 Boost Conversions with Personalization</h3>
              <p className="mt-4 text-lg md:text-xl leading-[1.2]">
