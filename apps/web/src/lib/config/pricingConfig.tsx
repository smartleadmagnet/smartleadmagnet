  ...
  plans: [
    {
      ...
      features: [
        ...
        { name: "100 AI Credits", hint: "You can buy extra credits later too or you can add your own API Key" },
        { name: "Valid for 1 Year", hint: "" },
        { name: "Access to Lead Magnet Builder", hint: "" },
        { name: "AI-Powered Personalization", hint: "" },
        { name: "Custom CSS", hint: "" },
        {
          name: "Email automation",
          hint: "Automatically engage with users who interacted with your lead magnet for better conversion.",
        },
        {
          name: "API access",
          hint: "Use our API to connect effortlessly with any application.",
        },
        {
          name: "Customized Solutions",
          hint: "Our team designs lead magnets just for you, helping you get more customers.",
        },
        {
    ...
    },
    {
      ...
      features: [
        ...
        { name: "250 AI Credits", hint: "You can buy extra credits later too or you can add your own API Key" },
    ...
    },
    {
      ...
      features: [
        ...
        {
          name: "250 AI Credits per month",
          hint: "You can buy extra credits later too or you can add your own API Key",
        },
