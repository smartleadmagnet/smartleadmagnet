...
`;
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="mx-auto max-w-4xl rounded-lg bg-white p-6 shadow-md">
        <h1 className="mb-4 text-3xl font-bold text-indigo-600">SmartLeadMagnet API Documentation</h1>

        <section className="mb-8">
          <h2 className="mb-2 text-2xl font-semibold text-gray-700">Getting Started</h2>
          ...
          <ol className="mt-4 list-inside list-decimal text-gray-600">
            <li>
              Log into your FoxyApps account at{" "}
              <a href="https://app.smartleadmagnet.com/" className="text-indigo-600 hover:underline">
                https://app.smartleadmagnet.com/
              </a>
              .
            </li>
            <li>
              Navigate to the API settings at{" "}
              <a href="https://app.smartleadmagnet.com/api" className="text-indigo-600 hover:underline">
                https://app.smartleadmagnet.com/api
              </a>
              .
            </li>
            <li>
        ...
        <section className="mb-8">
          <h2 className="mb-2 text-2xl font-semibold text-gray-700">Using the API</h2>
          <p className="text-gray-600">To make a request using your app, follow these steps:</p>
          <ol className="mt-4 list-inside list-decimal text-gray-600">
            <li>
              Send a POST request to:{" "}
              <span className="rounded bg-gray-100 p-1 text-gray-800">https://app.smartleadmagnet.com/api/app</span>
            </li>
            <li>Include your API key in the request headers (example below).</li>
            <li>
              Pass the <code>id</code> of your app and any input fields in the request body.
            </li>
          </ol>
  ...
  'Authorization': 'Bearer your_api_key',
        ...
        <section className="mb-8">
          <h2 className="mb-2 text-2xl font-semibold text-gray-700">Example Request</h2>
        ...
        <section className="mb-8">
          <h2 className="mb-2 text-2xl font-semibold text-gray-700">Credits and API Key Usage</h2>
          <p className="text-gray-600">
        ...
        <section className="mb-8">
          <h2 className="mb-2 text-2xl font-semibold text-gray-700">Error Handling</h2>
          <p className="text-gray-600">Ensure the following to avoid errors:</p>
          <ul className="mt-4 list-inside list-disc text-gray-600">
            <li>
              Check that you're using the correct app <code>id</code>.
            </li>
